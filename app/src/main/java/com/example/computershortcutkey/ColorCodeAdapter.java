...
public class ColorCodeAdapter extends RecyclerView.Adapter<ColorCodeAdapter.MyAdapterView> {


    private Context mcontext;
    private List<ColorCodeModel> mdata;

    public ColorCodeAdapter(Context mcontext, List<ColorCodeModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new ColorCodeAdapter.MyAdapterView(view);
    }
