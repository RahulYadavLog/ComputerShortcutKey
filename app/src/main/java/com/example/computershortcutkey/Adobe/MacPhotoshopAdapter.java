...
public class MacPhotoshopAdapter extends RecyclerView.Adapter<MacPhotoshopAdapter.MyAdapterView> {

    private Context mcontext;
    private List<MacPhotoshopModel> mdata;

    public MacPhotoshopAdapter(Context mcontext, List<MacPhotoshopModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.macphotoshop_list, viewGroup, false);

        return new MacPhotoshopAdapter.MyAdapterView(view);
    }
