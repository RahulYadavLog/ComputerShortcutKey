...
public class PhotoshopAdapter extends RecyclerView.Adapter<PhotoshopAdapter.MyAdapterView> {

    private Context mcontext;
    private List<PhotoshopModel> mdata;

    public PhotoshopAdapter(Context mcontext, List<PhotoshopModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.photoshop_list, viewGroup, false);

        return new PhotoshopAdapter.MyAdapterView(view);
    }
