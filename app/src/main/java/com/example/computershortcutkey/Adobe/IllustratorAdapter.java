...
public class IllustratorAdapter extends RecyclerView.Adapter<IllustratorAdapter.MyAdapterView> {

    private Context mcontext;
    private List<IllustratorModel> mdata;

    public IllustratorAdapter(Context mcontext, List<IllustratorModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new IllustratorAdapter.MyAdapterView(view);
    }
