...
public class MacIllustratorAdapter extends RecyclerView.Adapter<MacIllustratorAdapter.MyAdapterView> {

    private Context mcontext;
    private List<MacIllustratorModel> mdata;

    public MacIllustratorAdapter(Context mcontext, List<MacIllustratorModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.macillustrator_list, viewGroup, false);

        return new MacIllustratorAdapter.MyAdapterView(view);
    }
