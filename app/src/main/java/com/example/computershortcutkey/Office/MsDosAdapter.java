...
public class MsDosAdapter extends RecyclerView.Adapter<MsDosAdapter.MyAdapterView> {

    private Context mcontext;
    private List<MsDosModel> mdata;

    public MsDosAdapter(Context mcontext, List<MsDosModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new MsDosAdapter.MyAdapterView(view);
    }
