...
public class MsWordAdapter extends RecyclerView.Adapter<MsWordAdapter.MyAdapterView> {

    private Context mcontext;
    private List<MsWordModel> mdata;

    public MsWordAdapter(Context mcontext, List<MsWordModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.msword_list, viewGroup, false);

        return new MsWordAdapter.MyAdapterView(view);
    }
