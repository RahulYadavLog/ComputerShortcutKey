...
public class MsAccessAdapter extends RecyclerView.Adapter<MsAccessAdapter.MyAdapterView> {

    private Context mcontext;
    private List<MsAccessmodel> mdata;

    public MsAccessAdapter(Context mcontext, List<MsAccessmodel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.msaccess_list, viewGroup, false);

        return new MsAccessAdapter.MyAdapterView(view);
    }
