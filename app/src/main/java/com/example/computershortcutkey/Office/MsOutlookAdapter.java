...
public class MsOutlookAdapter extends RecyclerView.Adapter<MsOutlookAdapter.MyAdapterView> {
    private Context mcontext;
    private List<MsOutlookModel> mdata;

    public MsOutlookAdapter(Context mcontext, List<MsOutlookModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.msoutlook_list, viewGroup, false);

        return new MsOutlookAdapter.MyAdapterView(view);
    }
