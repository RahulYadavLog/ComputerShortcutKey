...
public class MsExcelAdapter extends RecyclerView.Adapter<MsExcelAdapter.MyAdapterView> {

    private Context mcontext;
    private List<MsExcelModel> mdata;

    public MsExcelAdapter(Context mcontext, List<MsExcelModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.msdos_list, viewGroup, false);

        return new MsExcelAdapter.MyAdapterView(view);
    }
