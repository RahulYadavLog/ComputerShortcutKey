...
public class MsPaintAdapter extends RecyclerView.Adapter<MsPaintAdapter.MyAdapterView> {

    private Context mcontext;
    private List<MsPaintModel> mdata;

    public MsPaintAdapter(Context mcontext, List<MsPaintModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.mspaint_list, viewGroup, false);

        return new MsPaintAdapter.MyAdapterView(view);
    }
