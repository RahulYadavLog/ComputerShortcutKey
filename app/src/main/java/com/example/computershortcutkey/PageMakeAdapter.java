...
public class PageMakeAdapter extends RecyclerView.Adapter<PageMakeAdapter.MyAdapterView> {


    private Context mcontext;
    private List<PagemakerModel> mdata;

    public PageMakeAdapter(Context mcontext, List<PagemakerModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new PageMakeAdapter.MyAdapterView(view);
    }
