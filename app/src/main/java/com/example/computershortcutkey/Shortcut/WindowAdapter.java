...
public class WindowAdapter  extends RecyclerView.Adapter<WindowAdapter.MyAdapterView> {

    private Context mcontext;
    private List<WindowModel> mdata;

    public WindowAdapter(Context mcontext, List<WindowModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.window_list, viewGroup, false);

        return new WindowAdapter.MyAdapterView(view);
    }
