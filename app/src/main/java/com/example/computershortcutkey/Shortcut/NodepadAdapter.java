...
public class NodepadAdapter extends RecyclerView.Adapter<NodepadAdapter.MyAdapterView> {

    private Context mcontext;
    private List<NotePadModel> mdata;

    public NodepadAdapter(Context mcontext, List<NotePadModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.notepad_list, viewGroup, false);

        return new NodepadAdapter.MyAdapterView(view);
    }
