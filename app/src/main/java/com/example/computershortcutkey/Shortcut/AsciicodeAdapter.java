...
public class AsciicodeAdapter extends RecyclerView.Adapter<AsciicodeAdapter.MyAdapterView> {


    private Context mcontext;
    private List<AsciicodeModel> mdata;

    public AsciicodeAdapter(Context mcontext, List<AsciicodeModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.tally_list, viewGroup, false);

        return new AsciicodeAdapter.MyAdapterView(view);
    }
