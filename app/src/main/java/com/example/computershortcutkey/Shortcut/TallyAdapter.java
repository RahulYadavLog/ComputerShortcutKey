...
public class TallyAdapter extends RecyclerView.Adapter<TallyAdapter.MyAdapterView> {

    private Context mcontext;
    private List<TallyModel> mdata;

    public TallyAdapter(Context mcontext, List<TallyModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new TallyAdapter.MyAdapterView(view);
    }
