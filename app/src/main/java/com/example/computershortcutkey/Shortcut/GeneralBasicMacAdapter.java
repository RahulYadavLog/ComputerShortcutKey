...
public class GeneralBasicMacAdapter extends RecyclerView.Adapter<GeneralBasicMacAdapter.MyAdapterView> {
    private Context mcontext;
    private List<GeneralBasicMacModel> mdata;

    public GeneralBasicMacAdapter(Context mcontext, List<GeneralBasicMacModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.generalbasicmac_list, viewGroup, false);

        return new GeneralBasicMacAdapter.MyAdapterView(view);
    }
