...
public class FirefoxAdapter extends RecyclerView.Adapter<FirefoxAdapter.MyAdapterView> {
    private Context mcontext;
    private List<FirefoxModel> mdata;

    public FirefoxAdapter(Context mcontext, List<FirefoxModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new FirefoxAdapter.MyAdapterView(view);
    }
