...
public class ExplorerAdapter extends RecyclerView.Adapter<ExplorerAdapter.MyAdapterView> {

    private Context mcontext;
    private List<ExplorerModel> mdata;

    public ExplorerAdapter(Context mcontext, List<ExplorerModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new ExplorerAdapter.MyAdapterView(view);
    }
