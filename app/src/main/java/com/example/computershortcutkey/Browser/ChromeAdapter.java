...
public class ChromeAdapter extends RecyclerView.Adapter<ChromeAdapter.MyAdapterView> {

    private Context mcontext;
    private List<ChromeModel> mdata;

    public ChromeAdapter(Context mcontext, List<ChromeModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new ChromeAdapter.MyAdapterView(view);
    }
