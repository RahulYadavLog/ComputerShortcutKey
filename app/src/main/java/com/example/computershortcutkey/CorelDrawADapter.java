...
public class CorelDrawADapter extends RecyclerView.Adapter<CorelDrawADapter.MyAdapterView>{


    private Context mcontext;
    private List<CorelDrawModel> mdata;

    public CorelDrawADapter(Context mcontext, List<CorelDrawModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new CorelDrawADapter.MyAdapterView(view);
    }
