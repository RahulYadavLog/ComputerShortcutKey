...
public class DreamWeaverAdapter extends RecyclerView.Adapter<DreamWeaverAdapter.MyAdapterView> {


    private Context mcontext;
    private List<DreamWeaverModel> mdata;

    public DreamWeaverAdapter(Context mcontext, List<DreamWeaverModel> mdata) {
    ...
    public MyAdapterView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new DreamWeaverAdapter.MyAdapterView(view);
    }
